...
/**
 * Created by Deathlymad on 05.04.2016.
 */
public class SubPlanAdapter extends ArrayAdapter<ArrayList<String>> {

    public SubPlanAdapter(Context context, int layout, int textRessource, List<ArrayList<String>> objects) {
        super(context, layout, textRessource, objects);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (v == null) {
            ...
            v = vi.inflate(R.layout.display_substituteplan_element, null);
        }
